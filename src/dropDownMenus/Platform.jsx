...
const liClass = "flex text-sm my-2 hover:text-blue-600 underline decoration-white hover:decoration-blue-700 text-black";
            ...
            <div className="flex items-start p-3">
                <div>
                    ...
                    <ul className="mx-3 grid grid-cols-4 grid-rows-2 w-[45rem] gap-1">
                        <Link to="/features/cash-on-delivery"><li className={liClass}>Cash on delivery</li></Link>
                        <Link to="/features/serviceable-pincodes"><li className={liClass}>Serviceable pincodes</li></Link>
                        <Link to="/features/api-integration"><li className={liClass}>API integration</li></Link>
                        <Link to="/features/multiple-pickup-location"><li className={liClass}>Multiple pickup location</li></Link>
                        <Link to="/features/print-shipping-label"><li className={liClass}>print shipping label</li></Link>
                        <Link to="/features/email-sms-notifications"><li className={liClass}>Email SMS notifications</li></Link>
                        <Link to="/features/amazon-self-ship"><li className={liClass}>Amazon self - ship</li></Link>
                        <li className="text-xs my-2 hover:text-blue-400 underline decoration-white hover:decoration-blue-200 text-blue-600">All Features</li>
                    </ul>
                </div>
            </div>
            {/* Refer & Earn */}
