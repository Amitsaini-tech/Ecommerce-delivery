            ...
            <div className="flex items-start p-3">
                <div>
                    ...
                    <ul className="mx-4 grid grid-cols-2 w-[33rem] gap-1">
                        <Link to="/partners/carrier">
                            <li className="grid text-sm my-2 hover:text-blue-600 underline decoration-white hover:decoration-blue-700 text-black">Carrier</li>
                        </Link>
                        <Link to="/partners/technology">
                            <li className="text-sm my-2 hover:text-blue-600 underline decoration-white hover:decoration-blue-700 text-black">Technology</li>
                        </Link>
                    </ul>
                </div>
            </div>
