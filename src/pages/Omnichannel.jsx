...
const Omnichannel = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{fontFamily:"'Poppins', sans-serif"}}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Omnichannel Fulfilment</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">End-to-end unified retail enablement. Sell on any channel — online, offline, or marketplace — and fulfil all orders from a single centralised inventory.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                {title:"Unified Inventory",desc:"One source of truth across all your active sales channels."},
                {title:"Channel Sync",desc:"Auto-sync orders from Flipkart, Amazon, Shopify and more."},
                {title:"Smart Routing",desc:"Intelligent order routing for maximum operational efficiency."}
            ].map((c, i) => (
