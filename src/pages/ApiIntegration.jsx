...
const ApiIntegration = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{fontFamily:"'Poppins', sans-serif"}}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">API Integration</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Integrate Elivery seamlessly into your platform. Our robust REST APIs let you automate shipping, track orders, and manage logistics programmatically.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                {title:"RESTful APIs",desc:"Clean, well-documented APIs for fast integration."},
                {title:"Webhooks",desc:"Real-time event notifications for every order update."},
                {title:"SDKs Available",desc:"Ready-to-use libraries for Node.js, Python and PHP."}
            ].map((c, i) => (
