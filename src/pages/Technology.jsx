...
const Technology = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{fontFamily:"'Poppins', sans-serif"}}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Technology Partners</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Build powerful logistics solutions with Elivery. Join our technology partner program and integrate our platform into your e-commerce or SaaS ecosystem.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                {title:"Plugin Support",desc:"Ready plugins for Shopify, WooCommerce and Magento."},
                {title:"Partner APIs",desc:"Full API access for logistics, tracking and billing."},
                {title:"Co-marketing",desc:"Joint marketing opportunities and featured partner listings."}
            ].map((c, i) => (
