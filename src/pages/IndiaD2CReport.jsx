...
const IndiaD2CReport = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{ fontFamily: "'Poppins', sans-serif" }}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">India D2C Report 2024</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">The definitive annual report on India's direct-to-consumer ecommerce ecosystem. Download trends, data, benchmarks, and forecasts for the year ahead.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                { title: "Market Size & Growth", desc: "Key metrics on India's fast-growing D2C market." },
                { title: "Category Insights", desc: "Top performing categories and emerging niches." },
                { title: "Logistics Benchmarks", desc: "Average shipping costs, RTOs, and delivery speeds." }
            ].map((c, i) => (
