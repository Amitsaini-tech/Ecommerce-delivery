...
const Returns = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{fontFamily:"'Poppins', sans-serif"}}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Returns & Refunds</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Painless returns and refund management. Build customer trust with a smooth, self-serve returns experience that significantly reduces support tickets.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                {title:"Self-Serve Portal",desc:"Customers initiate returns without contacting your support team."},
                {title:"Instant Refunds",desc:"Trigger refunds automatically upon pickup confirmation."},
                {title:"Return Analytics",desc:"Identify top return reasons and reduce future return rates."}
            ].map((c, i) => (
