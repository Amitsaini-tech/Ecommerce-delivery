...
const FAQs = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{ fontFamily: "'Poppins', sans-serif" }}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Frequently Asked Questions</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Quick answers to the most common questions about Elivery's shipping, billing, integrations, and account management.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                { title: "Shipping FAQs", desc: "Everything about pickups, deliveries, and tracking." },
                { title: "Billing FAQs", desc: "Invoices, COD remittance, and pricing explained." },
                { title: "Integration FAQs", desc: "Help with Shopify, WooCommerce, and API setups." }
            ].map((c, i) => (
