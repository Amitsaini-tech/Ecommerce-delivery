...
const KnowledgeBase = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{ fontFamily: "'Poppins', sans-serif" }}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Knowledge Base</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Everything you need to know about Elivery, all in one place. Step-by-step guides, how-to articles, and troubleshooting help for every feature.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                { title: "Step-by-Step Guides", desc: "Detailed walkthroughs for every Elivery feature." },
                { title: "Video Tutorials", desc: "Watch and learn at your own pace with video guides." },
                { title: "Search Anything", desc: "Full-text search across thousands of help articles." }
            ].map((c, i) => (
