...
const VolumetricWeightCalculator = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{ fontFamily: "'Poppins', sans-serif" }}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Volumetric Weight Calculator</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Calculate the chargeable weight of your shipment instantly. Couriers charge based on whichever is higher — actual weight or volumetric weight.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                { title: "Formula Explained", desc: "Vol. Weight = (L x W x H) / 5000 for most couriers." },
                { title: "Compare & Save", desc: "Know your chargeable weight before booking a shipment." },
                { title: "Avoid Surprises", desc: "Prevent unexpected billing by calculating upfront." }
            ].map((c, i) => (
