...
const Tracking = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{fontFamily:"'Poppins', sans-serif"}}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Real-Time Tracking</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Give customers complete shipment visibility. Real-time tracking across all courier partners from a single branded page reduces anxiety and builds brand loyalty.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                {title:"Live Updates",desc:"Push notifications triggered at every shipment milestone."},
                {title:"All Carriers",desc:"Unified tracking across all 25+ Elivery courier partners."},
                {title:"Branded Page",desc:"Custom tracking page with your own store branding and identity."}
            ].map((c, i) => (
