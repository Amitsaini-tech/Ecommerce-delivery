...
const Carrier = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{fontFamily:"'Poppins', sans-serif"}}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            <span className="text-blue-200 font-semibold uppercase tracking-widest text-xs md:text-sm">Partners</span>
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Carrier Partners</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Elivery partners with India's top courier companies to give you the best rates, fastest delivery times, and widest coverage — all managed from one platform.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                {title:"25+ Carriers",desc:"Choose from BlueDart, Delhivery, Ekart, DTDC and more."},
                {title:"Rate Comparison",desc:"Automatically pick the cheapest carrier for every order."},
                {title:"SLA Guarantee",desc:"Carrier SLAs are monitored and enforced by Elivery 24x7."}
            ].map((c, i) => (
