...
const PrintShippingLabel = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{fontFamily:"'Poppins', sans-serif"}}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Print Shipping Labels</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Generate and print professional shipping labels in a single click. Supports bulk printing for high-volume sellers with barcode and QR code support built in.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                {title:"Bulk Printing",desc:"Print thousands of labels at once in seconds."},
                {title:"Custom Branding",desc:"Add your logo and brand colors to every label."},
                {title:"Multiple Formats",desc:"Supports A4, A6 and thermal printer label formats."}
            ].map((c, i) => (
