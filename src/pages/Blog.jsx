...
const Blog = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{ fontFamily: "'Poppins', sans-serif" }}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Elivery Blog</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Stay ahead with insights on ecommerce logistics, shipping trends, carrier news, and business growth strategies written by industry experts.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                { title: "Industry Insights", desc: "Deep dives into logistics trends and market shifts." },
                { title: "Growth Playbooks", desc: "Actionable tips to scale your online business." },
                { title: "Case Studies", desc: "Real stories from sellers who scaled with Elivery." }
            ].map((c, i) => (
