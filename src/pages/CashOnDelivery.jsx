...
const CashOnDelivery = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{fontFamily:"'Poppins', sans-serif"}}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Cash on Delivery</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Accept cash payments at the doorstep. Elivery's COD service ensures secure, real-time cash collection with instant remittance to your account within 2 business days.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                {title:"Fast Remittance",desc:"COD amount transferred to your account within 2 working days."},
                {title:"24,000+ Pincodes",desc:"COD available across our entire delivery network."},
                {title:"Secure Collection",desc:"End-to-end secure cash handling by verified courier partners."}
            ].map((c, i) => (
