...
const Developers = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{ fontFamily: "'Poppins', sans-serif" }}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Developer Documentation</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Integrate Elivery into any platform using our REST APIs. Explore endpoints, authentication, webhooks, and code samples.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                { title: "REST APIs", desc: "Fully documented API reference with live examples." },
                { title: "Webhooks", desc: "Subscribe to real-time shipment lifecycle events." },
                { title: "SDKs & Libraries", desc: "Official Node.js, Python and PHP SDKs available." }
            ].map((c, i) => (
