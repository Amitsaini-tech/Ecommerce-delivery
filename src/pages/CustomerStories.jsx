...
const CustomerStories = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{ fontFamily: "'Poppins', sans-serif" }}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            <span className="text-blue-200 font-semibold uppercase tracking-widest text-xs md:text-sm">Resources</span>
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Customer Stories</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Discover how thousands of sellers across India use Elivery to reduce shipping costs, improve delivery speed, and delight their customers every day.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                { title: "Real Results", desc: "Measurable outcomes from real Elivery customers." },
                { title: "Diverse Industries", desc: "Stories from fashion, electronics, beauty and more." },
                { title: "Scalable Solutions", desc: "Learn how brands grow from 10 to 10,000 orders." }
            ].map((c, i) => (
