...
const IntercityDelivery = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{ fontFamily: "'Poppins', sans-serif" }}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            <span className="text-blue-200 font-semibold uppercase tracking-widest text-xs md:text-sm">Products · Shipping</span>
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Inter-City Delivery</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Speedy inter-city deliveries within hours. Connect any two cities with our express inter-city network for same-day or guaranteed next-morning delivery.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                { title: "Same-Day Intercity", desc: "Deliver between major cities on the very same day." },
                { title: "100+ Cities", desc: "Active inter-city express network across 100+ Indian cities." },
                { title: "Secure Handling", desc: "Tamper-proof packaging and dedicated dispatch handlers." }
            ].map((c, i) => (
...
export default IntercityDelivery;
