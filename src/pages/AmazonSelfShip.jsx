...
const AmazonSelfShip = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{fontFamily:"'Poppins', sans-serif"}}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Amazon Self-Ship</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Fulfil Amazon orders with your own courier network. Use Elivery to self-ship Amazon orders at lower costs while maintaining your seller performance metrics.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                {title:"Lower Costs",desc:"Ship Amazon orders cheaper than Amazon Logistics."},
                {title:"Seller Metrics Safe",desc:"Maintain your Amazon seller performance scores seamlessly."},
                {title:"Easy Sync",desc:"Auto-sync Amazon orders directly into your Elivery dashboard."}
            ].map((c, i) => (
