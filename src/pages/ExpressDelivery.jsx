...
const ExpressDelivery = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{fontFamily:"'Poppins', sans-serif"}}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">1-Day / 2-Day Delivery</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Guaranteed same-day or next-day order delivery. Boost customer satisfaction and reduce cart abandonment with our assured express delivery promise.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                {title:"Assured SLA",desc:"Committed next-day delivery backed by SLA guarantees."},
                {title:"Priority Handling",desc:"Orders are prioritized for immediate same-day dispatch."},
                {title:"Customer Trust",desc:"Display a fast-delivery badge on your store to increase conversions."}
            ].map((c, i) => (
