...
const Encyclopedia = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{ fontFamily: "'Poppins', sans-serif" }}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Logistics Encyclopedia</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Your go-to glossary for all things logistics and ecommerce. Understand every term from AWB and COD to LTL, NDR, RTO, and more.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                { title: "50+ Terms Defined", desc: "Clear, jargon-free definitions for logistics terms." },
                { title: "Searchable Glossary", desc: "Instantly find any logistics or ecommerce term." },
                { title: "Regularly Updated", desc: "New terms added as the industry evolves." }
            ].map((c, i) => (
