...
const Postship = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{fontFamily:"'Poppins', sans-serif"}}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Postship</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Branded post-purchase experience that turns one-time buyers into loyal, repeat customers. Customise every touchpoint that occurs after the order is placed.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                {title:"Branded Tracking",desc:"Custom tracking page with your brand colors and logo."},
                {title:"Review Requests",desc:"Automate post-delivery review and feedback collection."},
                {title:"Upsell Engine",desc:"Recommend products on the tracking page to boost order value."}
            ].map((c, i) => (
