...
const EmailSmsNotifications = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{fontFamily:"'Poppins', sans-serif"}}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Email & SMS Notifications</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Keep your customers informed at every step. Automated email and SMS alerts reduce WISMO calls and dramatically improve post-purchase satisfaction scores.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                {title:"Automated Alerts",desc:"Trigger notifications at every shipment milestone automatically."},
                {title:"Custom Templates",desc:"Brand your notifications with your own custom messaging."},
                {title:"WhatsApp Support",desc:"Send updates via WhatsApp for higher open and read rates."}
            ].map((c, i) => (
