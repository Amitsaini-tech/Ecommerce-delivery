...
const Warehouse = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{fontFamily:"'Poppins', sans-serif"}}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            <span className="text-blue-200 font-semibold uppercase tracking-widest text-xs md:text-sm">Products · Fulfilment</span>
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Warehouse & Fulfilment</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Store, pack and ship from 20,000+ warehouses located closest to your buyers. Reduce delivery time and shipping costs at the same time with smart fulfilment.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                {title:"20,000+ Warehouses",desc:"Distributed network for closest-to-buyer storage."},
                {title:"Managed Inventory",desc:"Real-time inventory management and multi-channel sync."},
                {title:"Faster Delivery",desc:"Ship from the nearest warehouse to cut transit time significantly."}
            ].map((c, i) => (
