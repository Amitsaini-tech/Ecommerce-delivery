...
const VideoAndPodcast = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{ fontFamily: "'Poppins', sans-serif" }}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Videos & Podcasts</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Watch, listen, and learn. Elivery's video library and podcast series cover shipping tips, seller interviews, platform walkthroughs, and logistics deep-dives.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                { title: "How-To Videos", desc: "Quick walkthroughs of every Elivery feature." },
                { title: "Seller Interviews", desc: "Listen to stories from successful D2C founders." },
                { title: "Logistics Podcasts", desc: "Expert conversations on supply chain trends." }
            ].map((c, i) => (
