...
const B2BShipping = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{fontFamily:"'Poppins', sans-serif"}}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">B2B & Bulk Shipping</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Ship large volumes to retailers, distributors, and businesses. Reach 220+ countries with competitive freight rates and a dedicated enterprise support team.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                {title:"220+ Countries",desc:"Global reach for all your cross-border B2B shipments."},
                {title:"Volume Discounts",desc:"Aggressive pricing tiers for high-volume shippers."},
                {title:"Dedicated Account",desc:"A dedicated account manager for every enterprise client."}
            ].map((c, i) => (
