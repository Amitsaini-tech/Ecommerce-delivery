...
const EcommerceShipping = () => (
    <div className="min-h-screen bg-white pt-20 px-6 md:px-16 lg:px-32" style={{fontFamily:"'Poppins', sans-serif"}}>
        ...
        <div className="w-full bg-blue-700 rounded-2xl px-8 md:px-14 py-12 md:py-16 mt-6">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mt-3 mb-4">Ecommerce Shipping</h1>
            <p className="text-blue-100 text-base md:text-lg max-w-2xl">Automated shipping for online sellers. Get the lowest rates, fastest transit times, and complete order visibility — all from a single, easy-to-use dashboard.</p>
            <Link to="/Login">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 mb-12">
            {[
                {title:"Automated Dispatch",desc:"Orders auto-assigned to the best carrier instantly."},
                {title:"Lowest Rates",desc:"Save up to 40% on shipping costs with our carrier network."},
                {title:"Real-time Tracking",desc:"Live tracking links sent automatically to your customers."}
            ].map((c, i) => (
